    ...
    >
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          aria-label="Close enquiry form"
          className="absolute right-4 top-4 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/90 text-slate-500 shadow-md transition hover:bg-white hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
        >
          <X className="h-5 w-5" />
        </button>

        {/* Header */}
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 px-6 py-8 text-white sm:px-8">
          {/* Decorative glow */}
          <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-cyan-400/20 blur-3xl" />

          <div className="relative">
            {/* Placement Badge */}
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-2 text-xs font-bold uppercase tracking-[0.14em] text-blue-50 backdrop-blur-sm">
              <BriefcaseBusiness className="h-4 w-4" />
              In-House Placement
            </div>

            {/* Icon */}
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-white/15 shadow-lg">
              <GraduationCap className="h-6 w-6" />
            </div>
            ...
            <h2
              id="global-lead-title"
              className="pr-12 text-2xl font-black leading-tight sm:text-3xl"
            >
              Start Your Career Journey
            </h2>

            <p className="mt-3 max-w-md text-sm leading-6 text-blue-100">
              Get expert career counselling, industry-focused
              training, and support from our in-house placement
              team.
            </p>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-blue-600 px-5 py-4 font-bold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading
              ? "Submitting..."
              : "Get Free Counselling"}
