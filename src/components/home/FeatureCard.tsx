...
export default function FeatureCard({
  ...
  return (
    ...
    >
      <div
        className={`icon-pulse-wrap relative flex h-16 w-16 items-center justify-center rounded-2xl transition-all duration-300 ${styles.bg} ${styles.fg} ${styles.hoverBg}`}
      >
        <span className="icon-pulse-ring" />

        <Icon
          className={`relative z-10 h-8 w-8 transition ${styles.fg} group-hover:text-white`}
        />
      </div>
