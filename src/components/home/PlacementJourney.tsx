...
//   return (
//     <section className="relative overflow-hidden bg-[#F4F6FF] py-16 lg:py-20">
//       {/* Background */}
...
export default function PlacementJourney() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#EEF3FF] via-[#F4F6FF] to-[#EAFBF3] py-16 lg:py-20">
      {/* Background */}
      <div className="absolute inset-0">
        <div className="absolute left-0 top-0 h-96 w-96 rounded-full bg-[#2E5EFF]/10 blur-3xl" />
        <div className="absolute right-0 bottom-0 h-96 w-96 rounded-full bg-[#16C79A]/10 blur-3xl" />
