...
// //           {/* Left — story */}
// //           <div>
// //             <span className="inline-flex rounded-full bg-white/10 px-4 py-2 text-sm font-semibold uppercase tracking-widest text-blue-300 backdrop-blur">
// //               Who We Are
// //             </span>
...
// //             {credentials.map(({ value, label, Icon }) => (
// //               <div
// //                 key={label}
// //                 className="group rounded-3xl border border-white/10 bg-white/5 p-7 backdrop-blur transition-all duration-300 hover:-translate-y-2 hover:border-blue-400/50 hover:bg-white/10"
// //               >
// //                 <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-500/15 transition group-hover:bg-blue-500">
// //                   <Icon className="h-7 w-7 text-blue-300 transition group-hover:text-white" />
// //                 </div>

// //                 <h3 className="mt-6 text-3xl font-black">{value}</h3>
