    ...
    <div className="relative h-[430px] w-[520px] max-w-full shrink-0">
      ...
      {studentImages[3] && (
        <HeroStudent
          src={studentImages[3]}
          size="small"
          className="absolute right-[75px] top-[10px] z-20"
        />
      )}
      ...
      <div className="absolute right-[15px] bottom-[20px] z-30 animate-float [animation-delay:2.1s]">
        <div className="flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-2 shadow-xl backdrop-blur-xl transition-transform duration-300 hover:scale-105 sm:px-4 sm:py-2.5">
          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-blue-500/20 sm:h-8 sm:w-8">
      ...
      <div className="absolute left-[275px] top-[300px] z-30 rounded-2xl border border-white/10 bg-white/10 px-4 py-3 shadow-xl backdrop-blur-xl sm:px-5">
