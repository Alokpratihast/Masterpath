...
//                   <Link
//                     href={link.href}
//                     className="inline-flex h-12 items-center gap-1.5 rounded-xl px-4 text-base font-bold text-white/95 transition hover:bg-white/10 hover:text-white"
//                   >
//                     Our Courses
...
//                   key={link.href}
//                   href={link.href}
//                   className="inline-flex h-12 items-center rounded-xl px-4 text-base font-bold text-white/95 transition hover:bg-white/10 hover:text-white"
//                 >
//                   {link.label}
//                 </Link>
//               ),
...
//             <Link
//               href="/contact"
//               className="inline-flex h-12 items-center justify-center rounded-xl border-2 border-white/70 bg-white/5 px-5 text-sm font-bold text-white backdrop-blur-sm transition-all duration-300 hover:border-white hover:bg-white/10"
//             >
...
//             <a
//               href={`tel:${siteConfig.phone.replaceAll(" ", "")}`}
//               className="grid h-10 w-10 place-items-center rounded-xl border-2 border-white/40 bg-white/5 text-white transition hover:border-white hover:bg-white/10 sm:h-11 sm:w-11"
