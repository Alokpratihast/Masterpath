...
//             <div className="absolute -bottom-7 left-5 right-5 grid grid-cols-3 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-xl sm:left-8 sm:right-8">
...
//         <div className="mt-20 grid gap-5 md:grid-cols-3 lg:mt-24">
